...
export const linearIntegrationI18n = {
  ...
  ru: {
    'settings.integrations.github.title': 'GitHub',
    'settings.integrations.github.description': 'Подключите аккаунт GitHub для pull request и issues.',
    ...
    'settings.integrations.firstParty.info': 'Аккаунты сервисов и встроенных расширений OpenChamber. Данные авторизации хранятся на выбранном инстансе.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Подключайте рабочие пространства Linear на этом сервере OpenChamber.',
    'settings.integrations.linear.info': 'Подключите одно или несколько рабочих пространств Linear. OpenChamber хранит входы на этом компьютере, поэтому веб, десктоп и спаренный телефон используют их совместно.',
    ...
    'settings.integrations.linear.actions.switchTo': 'Переключить на',
    ...
    'settings.integrations.linear.toast.authorizationFailed': 'Время авторизации Linear истекло. Нажмите «Подключить» и попробуйте снова.',
    'settings.integrations.linear.avatarAlt.withName': 'Аватар Linear для {name}',
    'settings.integrations.linear.avatarAlt.fallback': 'Аватар Linear',
    ...
    'settings.integrations.linear.mapping.defaultProject.info': 'Новые сессии из задач Linear используют этот проект, если у команды задачи нет собственной привязки.',
    ...
    'settings.integrations.linear.mapping.teams.info': 'Необязательно. Задача из привязанной команды откроется в этом проекте, а не в проекте по умолчанию.',
    ...
    'settings.integrations.linear.mapping.emptyProjects': 'Сначала добавьте проект, затем привяжите к нему команды Linear.',
    'settings.integrations.linear.mapping.emptyTeams': 'В этом рабочем пространстве Linear нет команд.',
    'settings.integrations.linear.mapping.loadFailed': 'Не удалось загрузить привязку проектов Linear.',
    'settings.integrations.linear.sessionComments.label': 'Комментарии о сессии',
    'settings.integrations.linear.sessionComments.info': 'Добавляет комментарий к задаче, когда сессия начинается, завершается или завершается с ошибкой. Комментарии публикуются, только если у этого сервера есть публичный адрес, чтобы ссылка открывала сессию всем участникам задачи.',
    ...
    'settings.magicPrompts.sidebar.group.linear': 'Linear',
    'settings.magicPrompts.sidebar.item.linearIssueReview': 'Обзор issue',
    'settings.magicPrompts.page.group.linearIssueReview.title': 'Обзор issue',
    'settings.magicPrompts.page.group.linearIssueReview.description': 'Промпты, используемые при старте сессии из задачи Linear: видимое сообщение пользователя и скрытые инструкции.',
  },
} as const;
