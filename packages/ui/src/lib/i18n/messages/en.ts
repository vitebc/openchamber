...
export const dict = {
  ...
  'session.newWorktree.error.projectNotRegistered': 'Project is not registered in OpenChamber',
  'session.newWorktree.error.sessionCreateFailed': 'Could not create a session for the worktree',
  ...
  'chat.messageBody.forkDialog.toast.forked': 'Forked from {title}',
  'chat.messageBody.forkDialog.toast.forkFailed': 'Failed to fork session',
  ...
  'chat.permissionToast.respondFailed': 'Failed to respond to permission request',
  ...
  'openCodeStatusDialog.toast.collectFailed': 'Failed to collect OpenCode status',
  ...
  'desktopHostSwitcher.instance.localOpenChamber': 'Local OpenChamber',
