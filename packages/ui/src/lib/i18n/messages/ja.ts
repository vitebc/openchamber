...
export const dict: Record<I18nKey, string> = {
  ...
  'session.newWorktree.error.projectNotRegistered': 'プロジェクトはOpenChamberに登録されていません',
  'session.newWorktree.error.sessionCreateFailed': 'ワークツリー用のセッションを作成できませんでした',
  ...
  'chat.messageBody.forkDialog.toast.forked': '「{title}」からフォークしました',
  'chat.messageBody.forkDialog.toast.forkFailed': 'セッションのフォークに失敗しました',
  ...
  'chat.permissionToast.respondFailed': '権限リクエストへの応答に失敗しました',
  ...
  'openCodeStatusDialog.toast.collectFailed': 'OpenCodeのステータスの取得に失敗しました',
  ...
  'desktopHostSwitcher.instance.localOpenChamber': 'ローカル OpenChamber',
