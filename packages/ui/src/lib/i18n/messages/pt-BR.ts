...
export const dict: Record<I18nKey, string> = {
  ...
  "session.newWorktree.error.projectNotRegistered": "O projeto não está registrado no OpenChamber",
  "session.newWorktree.error.sessionCreateFailed": "Não foi possível criar uma sessão para o worktree",
  ...
  "chat.messageBody.forkDialog.toast.forked": "Ramificação criada a partir de {title}",
  "chat.messageBody.forkDialog.toast.forkFailed": "Falha ao ramificar a sessão",
  ...
  "chat.permissionToast.respondFailed": "Falha ao responder à solicitação de permissão",
  ...
  "openCodeStatusDialog.toast.collectFailed": "Falha ao coletar o status do OpenCode",
  ...
  "desktopHostSwitcher.instance.localOpenChamber": "OpenChamber local",
