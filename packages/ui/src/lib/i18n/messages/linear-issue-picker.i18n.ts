...
export const linearIssuePickerI18n = {
  ...
  ru: {
    ...
    'session.linearIssuePicker.description': 'Выберите задачу из подключённого рабочего пространства Linear.',
    ...
    'session.linearIssuePicker.toast.loadMoreFailed': 'Не удалось загрузить ещё задачи',
    'session.linearIssuePicker.toast.loadIssueDetailsFailed': 'Не удалось загрузить детали задачи',
    ...
    'session.linearIssuePicker.description.createSession': 'Создаёт сессию в проекте, привязанном к этой команде Linear, с задачей в качестве первого запроса.',
    'session.linearIssuePicker.error.noMappedProject': 'Привяжите эту команду Linear к проекту в «Настройки → Интеграции»',
    ...
    'session.linearIssuePicker.actions.toggleWorktreeAria': 'Переключить ворктрей',
    'session.linearIssuePicker.actions.createInWorktree': 'Создать в ворктрее',
