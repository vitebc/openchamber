...
export const dict: Record<I18nKey, string> = {
  ...
  'session.newWorktree.error.projectNotRegistered': '프로젝트가 OpenChamber에 등록되어 있지 않습니다',
  'session.newWorktree.error.sessionCreateFailed': '워크트리에 대한 세션을 만들 수 없습니다',
  ...
  'chat.messageBody.forkDialog.toast.forked': '{title}에서 분기를 만들었습니다',
  'chat.messageBody.forkDialog.toast.forkFailed': '세션 분기에 실패했습니다',
  ...
  'chat.permissionToast.respondFailed': '권한 요청에 응답하지 못했습니다',
  ...
  'desktopHostSwitcher.instance.localOpenChamber': '로컬 OpenChamber',
