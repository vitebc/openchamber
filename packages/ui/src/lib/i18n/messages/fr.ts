...
export const dict = {
  ...
  'session.newWorktree.error.projectNotRegistered': 'Le projet n’est pas enregistré dans OpenChamber',
  'session.newWorktree.error.sessionCreateFailed': 'Impossible de créer une session pour le worktree',
  ...
  'chat.permissionToast.respondFailed': 'Échec de la réponse à la demande d’autorisation',
  ...
  'openCodeStatusDialog.toast.collectFailed': 'Échec de la collecte du statut OpenCode',
  ...
  'chat.messageBody.forkDialog.toast.forked': 'Fourche créée à partir de {title}',
  'chat.messageBody.forkDialog.toast.forkFailed': 'Échec de la création de la fourche',
