...
export const dict: Record<I18nKey, string> = {
  ...
  'session.newWorktree.error.projectNotRegistered': '项目尚未在OpenChamber中注册',
  'session.newWorktree.error.sessionCreateFailed': '无法为工作树创建会话',
  ...
  'chat.messageBody.forkDialog.toast.forked': '已从“{title}”创建分支',
  'chat.messageBody.forkDialog.toast.forkFailed': '创建会话分支失败',
  ...
  'chat.permissionToast.respondFailed': '未能响应权限请求',
  ...
  'openCodeStatusDialog.toast.collectFailed': '未能收集OpenCode状态',
  ...
  'desktopHostSwitcher.instance.localOpenChamber': '本地 OpenChamber',
