...
export const dict: Record<I18nKey, string> = {
  ...
  'session.newWorktree.error.projectNotRegistered': '專案尚未在OpenChamber中註冊',
  'session.newWorktree.error.sessionCreateFailed': '無法為 worktree 建立工作階段',
  ...
  'chat.messageBody.forkDialog.toast.forked': '已從「{title}」建立分支',
  'chat.messageBody.forkDialog.toast.forkFailed': '建立工作階段分支失敗',
  ...
  'chat.permissionToast.respondFailed': '未能回應權限請求',
  ...
  'openCodeStatusDialog.toast.collectFailed': '未能收集OpenCode狀態',
  ...
  'desktopHostSwitcher.instance.localOpenChamber': '本機 OpenChamber',
