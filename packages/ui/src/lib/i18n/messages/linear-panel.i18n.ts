...
export const linearPanelI18n = {
  ...
  ru: {
    'contextPanel.mode.linear': 'Linear',
    'contextRail.surface.linear.description': 'Просматривайте задачи Linear, меняйте статус и запускайте сессию',
    ...
    'contextPanel.linear.error.noCompletedState': 'У этой команды нет завершающего статуса',
  },
} as const;
