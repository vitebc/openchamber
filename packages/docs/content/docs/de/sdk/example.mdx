...
Baue sie aus dem Ordner mit `bunx openchamber-guest-bundle panel/main.ts panel/main.js` und füge den Ordner dann unter Einstellungen → Erweiterungen hinzu. Sechs weitere Beispiele (jedes UI-Element, eine Aufgabenliste mit Aktionen und einem Slash-Befehl, ein lokaler Dienst, ein Editor für Konfigurationsdateien, ein reines Tools-Paket, ein Work-Status-Abschnitt mit Git-Graph) liegen auf [github.com/openchamber/openchamber/tree/main/packages/sdk/examples](https://github.com/openchamber/openchamber/tree/main/packages/sdk/examples).
