...
Compílala desde la carpeta con `bunx openchamber-guest-bundle panel/main.ts panel/main.js` y luego añade la carpeta en Ajustes → Extensiones. Hay seis ejemplos más (todos los controles de UI, una lista de tareas con acciones y un comando de barra, un servicio local, un editor de archivo de configuración, un paquete solo de herramientas, una sección de Work Status con un grafo de git) en [github.com/openchamber/openchamber/tree/main/packages/sdk/examples](https://github.com/openchamber/openchamber/tree/main/packages/sdk/examples).
