...
Зберіть його з теки командою `bunx openchamber-guest-bundle panel/main.ts panel/main.js`, а потім додайте теку в Налаштування → Розширення. Ще шість прикладів (кожен елемент UI, список задач із діями та командою слеша, локальний сервіс, редактор конфігураційного файлу, пакет лише з інструментами, секція Work Status із git-графом) лежать на [github.com/openchamber/openchamber/tree/main/packages/sdk/examples](https://github.com/openchamber/openchamber/tree/main/packages/sdk/examples).
